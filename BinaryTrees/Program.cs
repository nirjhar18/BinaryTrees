    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           RecursiveTree.PreOrderTraversal(RecursiveTree.root);
            ...
            Console.WriteLine("Sum of 194 has a path in Binary Tree: " + RecursiveTree.RootToLeafSum(RecursiveTree.root,194, PathList));


            RecursiveTree.delete(42);

            RecursiveTree.delete(62);

            Boolean CheckBinary = RecursiveTree.CheckIfBinary(RecursiveTree.root, int.MinValue, int.MaxValue);

            Console.WriteLine("Is it a BST " + CheckBinary);
